...
const zh = {
  common: {
    ...
    packageStatus: { received: "已接收", notified: "已通知", pickedUp: "已出库" },
    storageBins: {
      uncategorized: {
        label: "未分类",
  ...
  auth: {
    signInDescription: "登录以管理包裹入库和出库。", signUpDescription: "管理员由主机方提升；普通用户只能查看与自己关联的包裹。",
  ...
  myPackages: {
    ...
    metrics: { waiting: "待出库", pickedUp: "已出库", total: "包裹总数" },
    sections: { current: "当前包裹", history: "出库记录", empty: "您目前没有待出库包裹。" },
    status: {
      received: { label: "已接收", description: "您的包裹已到达，正在准备出库。" },
      notified: { label: "可出库", description: "您的包裹已准备好出库。" },
      pickedUp: { label: "已出库", description: "此包裹已完成出库。" },
    },
    fields: { description: "描述", received: "接收时间", trackingNumber: "追踪号", storageLocation: "存放位置", pickedUp: "出库时间" },
  ...
  pickup: {
    ...
    confirm: {
      title: "确认出库", description: "完成出库前，请核对详细信息。", barcode: "条码", recipient: "收件人",
      packageDescription: "描述", bin: "储物箱", received: "接收日期", collectedBy: "交付给（可选）",
      collectedByPlaceholder: "接收包裹人员姓名", action: "确认出库",
    },
    success: { title: "包裹已出库", description: "{{recipientName}} 的包裹 {{barcode}} 已完成出库。", scanNext: "扫描下一个" },
    errors: {
      notFound: "未找到条码为“{{barcode}}”的包裹。", alreadyPickedUp: "此包裹已于 {{date}} 出库。",
      lookupFailed: "查询失败", camera: "无法访问相机，请检查权限。",
    },
  },
  packages: {
    title: "包裹", description: "查看和搜索所有已登记包裹。", searchPlaceholder: "搜索条码、描述、订单号…",
    filters: { active: "当前（待出库）", all: "全部" }, empty: "未找到包裹。", noDescription: "无描述",
  ...
  recipients: {
    ...
    dialog: {
      ...
      notesLabel: "备注", notesPlaceholder: "例如：希望周末出库",
    },
  },
  users: {
